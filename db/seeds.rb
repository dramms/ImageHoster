...
Message.create(:conversation_id => 1, :user_id => 2, :content => "Hab da noch etwas am Design in Freunde geändert")
Message.create(:conversation_id => 1, :user_id => 1, :content => "sieht echt gut aus")
Message.create(:conversation_id => 1, :user_id => 2, :content => "Was jetzt noch?")
Message.create(:conversation_id => 1, :user_id => 1, :content => "Seeds erstellen...")
...
p = Project.new(:title => "Ex-Freundinnen", :content => "Fotos von Ex's", :user_id => 2)
p.save
i = Image.new(:title => "Ex 1", :content => "Foto Ex 1", :project_id => p.id)
i.save
i = Image.new(:title => "Ex 2", :content => "Foto Ex 2", :project_id => p.id)
i.save
i = Image.new(:title => "Ex 3", :content => "Foto Ex 3", :project_id => p.id)
i.save

p = Project.new(:title => "Mac-Bilder", :content => "Fotos von Apple MacBooks", :user_id => 3)
p.save
i = Image.new(:title => "Mac 1", :content => "Foto Mac 1", :project_id => p.id)
i.save
i = Image.new(:title => "Mac 2", :content => "Foto Mac 2", :project_id => p.id)
i.save
i = Image.new(:title => "Mac 3", :content => "Foto Mac 3", :project_id => p.id)
i.save
p = Project.new(:title => "iPhone-Bilder", :content => "Fotos von Apple iPhones", :user_id => 3)
p.save
i = Image.new(:title => "iPhone 1", :content => "Foto iPhone 1", :project_id => p.id)
i.save
i = Image.new(:title => "iPhone 2", :content => "Foto iPhone 2", :project_id => p.id)
i.save
i = Image.new(:title => "iPhone 3", :content => "Foto iPhone 3", :project_id => p.id)
i.save
p = Project.new(:title => "iPad-Bilder", :content => "Bilder von iPads", :user_id => 3)
p.save
i = Image.new(:title => "iPads 1", :content => "Foto iPads 1", :project_id => p.id)
i.save
i = Image.new(:title => "iPads 2", :content => "Foto iPads 2", :project_id => p.id)
i.save
i = Image.new(:title => "iPads 3", :content => "Foto iPads 3", :project_id => p.id)
i.save
